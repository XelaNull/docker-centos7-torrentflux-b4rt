...
GRANT ALL PRIVILEGES ON *.* to torrentflux@'%' IDENTIFIED BY 'A233^&dsddd';
GRANT ALL PRIVILEGES ON *.* to torrentflux@localhost IDENTIFIED BY 'A233^&dsddd';
FLUSH PRIVILEGES;
USE torrentflux;
...
INSERT INTO tf_settings VALUES ('bin_unrar','/usr/local/bin/unrar');
INSERT INTO tf_settings VALUES ('bin_unzip','/usr/bin/unzip');
INSERT INTO tf_settings VALUES ('bin_cksfv','/usr/local/bin/cksfv');
...
INSERT INTO tf_settings VALUES ('enable_home_dirs','0');
